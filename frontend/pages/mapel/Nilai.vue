    ...
    <div id="nilai" class="py-2">
      ...
      <el-card class="bg-white/[0.7]"
        ...
        <div class="relative bg-white">
          ...
          <div v-else class="mb-12" v-loading="loading">
            <!-- <div class="mx-3">
              <el-switch />
...
import { useDataStore } from '@/config/stores/dataStore'
  ...
  export default {
    ...
    watch: {
      ...
      'filter.id_kelas' (val){
        if (!this.initial) {
          this.filterFields.id_mapel.options = this.filterFields.id_kelas.options[val]?.options ?? []
          this.filter.id_mapel = Object.values(this.filterFields.id_mapel.options)[0]?.value
        }
      },
      'filter.id_mapel' (val) {
      ...
      getInitial: async function() {
          ...
          this.$http.get('mapel/admin/pembagian/options',{
            ...
            .then(res => {
              ...
              this.filterFields.id_mapel.options = this.filterFields.id_kelas.options[this.filter.id_kelas]?.options

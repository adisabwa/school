<template>
  ...
  >
    ...
    >
      ...
      >
        <icons icon="vaadin:line-bar-chart" class="text-emerald-600" />
    ...
    <div class="flex-1 overflow-x-auto p-4">
        ...
        <template #header="{data}">
          <tr>
            ...
            <th class="p-3.5 text-center text-[11px] font-black text-emerald-600 uppercase tracking-widest">
              Hadir
            </th>
        ...
        <template #body="{data}">
          ...
          >
            ...
            <td class="p-3.5 text-center">
              <span
                class="inline-block px-3.5 py-1.5 rounded-xl bg-emerald-50 text-emerald-700 font-black text-base"
              >
                {{ stat.hadir }}
              </span>
            </td>
...
export default {
  ...
  data() {
    return {
      ...
      legendItems: [
        { label: 'H', dotClass: 'bg-emerald-500 shadow-emerald-200' },

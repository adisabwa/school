<template>
	<div class="py-6 md:px-10 text-center bg-white/[0.8] relative" >
		<div class="p-5 px-2 md:px-5 mx-auto space-y-3 md:space-y-6">
			<div
				...
				<div class="flex-1 text-center md:text-left">
					...
					>
						...
						<span class="text-emerald-100 text-[14px] font-bold">
			...
			<div
				class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 3xl:grid-cols-4 gap-4 lg:gap-5 pb-20"
			>
				<div
				...
				>
					<!-- Header -->
					<div class="flex items-center gap-3 lg:gap-4 mb-1 md:mb-2">
						...
						<div class="overflow-hidden text-left">
							<div
								class="text-base font-black text-slate-900 truncate group-hover:text-emerald-700 transition-colors leading-tight"
							>
								{{ student.nama }}
							</div>
							<div
						...
						<el-button
							...
							:class="
								student.kehadiran === status
									? `${statusLabels[status].activeBg} text-white shadow-md shadow-emerald-100`

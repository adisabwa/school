...
<template>
	<div class="mt-[40px] sm:mt-0 relative">
    ...
    <div class="sm:hidden absolute w-full h-[70px] px-2 mt-0 z-[3]
      ...
      <div class="absolute right-0 top-1/2 -translate-y-1/2
        ...
        text-white px-4 py-1 font-semibold"
          @click="doLogout">
        <icons class="text-[30px]" icon="mdi:logout"/>
      </div>
      <el-dialog v-model="showRole"
		...
		<div id="management" class="flex flex-col justify-center mx-1 sm:mx-auto pt-20 md:pt-4 pb-20
      overflow-hidden">

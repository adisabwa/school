...
<template>
    ...
    <div class="sm:hidden absolute w-full h-[70px] px-2 mt-0 z-[3]
      ...
      Assalamu'alaikum,<br/>
      <div class="text-xl font-semibold">{{ isEmpty(user.nama) ? 'Tamu' : user.nama }}</div>
...
export default {
  ...
  setup(){
    ...
    return {
      isEmpty, ucFirst, getDataFromStorage, saveToStorage, removeFromStorage, getColor, openLink,
    }
  },
  components: {
  },

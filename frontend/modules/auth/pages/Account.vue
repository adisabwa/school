	...
	<div id="account-page">
		<el-card class="mx-2 bg-white pt-[50px] pb-10">
          ...
          rounded-full overflow-hidden relative
					...
					border-3 border-solid border-[var(--color-main-700)]"
          ...
          <div v-if="!isEmpty(viewValue.photo)"
            ...
            />
					<icons v-else 
            icon="mdi:user" class="mr-0 text-[var(--color-main-700)] text-[100px]"/>
				</div>
				...
				<div class="mt-6 flex items-center justify-center gap-2">
					<el-button class="mt-1 flex items-center
						w-full rounded-[10px] mx-0 bg-[var(--color-main-700)] 
						text-[var(--color-main-100)] font-bold"
						@click="showEdit = true;
              showColumns=[];
              getInitial();">
						<icons icon="mdi:edit"/>

                ...
                children: [
                  {
                    ...
                    component: () => import('@/pages/perpustakaan/Dashboard.vue'),
                  },  
                ],
            },
            {
                ...
                children: [
                  {
                    path: 'buku',
                    name: 'buku-list', 
                    component: () => import('@/pages/perpustakaan/admin/Buku.vue'),
                    meta: {
                  ...
                  },
                  {
                    ...
                    component: () => import('@/pages/perpustakaan/admin/Peminjaman.vue'),
                    meta: {

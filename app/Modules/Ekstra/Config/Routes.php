    ...
    $routes->group('ts', static function ($routes) {
        $routes->group('tsdac', static function ($routes) {
            $routes->group('penilaian', static function ($routes) {
                addDefaultRoutes($routes, NilaiController::class, 'sch_ts_tsdac_penilaian');
            ...
            $routes->group('peserta', static function ($routes) {
                addDefaultRoutes($routes, Modules\Ekstra\Controllers\Tsdac\PesertaController::class, 'sch_ts_tsdac_peserta');
            });
        });
    });
});